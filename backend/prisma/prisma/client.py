...
SCHEMA_PATH = Path('/home/jkawa/100x/Investment Tracker and Portfolio Analysis/backend/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'debian-openssl-3.0.x': '/home/jkawa/.cache/prisma-python/binaries/5.17.0/393aa359c9ad4a4bb28630fb5613f9c281cde053/node_modules/prisma/query-engine-debian-openssl-3.0.x'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    historicaldata: 'actions.HistoricalDataActions[models.HistoricalData]'
    ...
    def __init__(
        ...
        *,
        ...
        self.historicaldata = actions.HistoricalDataActions[models.HistoricalData](self, models.HistoricalData)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': '/home/jkawa/100x/Investment Tracker and Portfolio Analysis/backend/prisma/schema.prisma',
        }
...
class Batch:
    ...
    historicaldata: 'HistoricalDataBatchActions'
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.historicaldata = HistoricalDataBatchActions(self)
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class HistoricalDataBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher
