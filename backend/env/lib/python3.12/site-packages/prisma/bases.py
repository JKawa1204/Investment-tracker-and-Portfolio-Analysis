...
class BasePortfolio(_PrismaModel):
    __prisma_model__: ClassVar[Literal['Portfolio']] = 'Portfolio'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.PortfolioActions[_PrismaModelT]':
        from .client import get_client

        return actions.PortfolioActions[_PrismaModelT](client or get_client(), cls)
