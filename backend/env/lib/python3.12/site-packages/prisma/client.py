...
class Prisma(AsyncBasePrisma):
    ...
    portfolio: 'actions.PortfolioActions[models.Portfolio]'
    ...
    def __init__(
        ...
        *,
        ...
        self.portfolio = actions.PortfolioActions[models.Portfolio](self, models.Portfolio)
...
class Batch:
    portfolio: 'PortfolioBatchActions'
    ...
    def __init__(self, client: Prisma) -> None:
        ...
        self.portfolio = PortfolioBatchActions(self)
...
class PortfolioBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher

    def create(
        self,
        data: types.PortfolioCreateInput,
        include: Optional[types.PortfolioInclude] = None
    ) -> None:
        self._batcher._add(
            method='create',
    ...
    def create_many(
        self,
        data: List[types.PortfolioCreateWithoutRelationsInput],
        *,
    ...
    def delete(
        self,
        where: types.PortfolioWhereUniqueInput,
        include: Optional[types.PortfolioInclude] = None,
    ) -> None:
        self._batcher._add(
            method='delete',
    ...
    def update(
        self,
        data: types.PortfolioUpdateInput,
        where: types.PortfolioWhereUniqueInput,
        include: Optional[types.PortfolioInclude] = None
    ) -> None:
        self._batcher._add(
    ...
    def upsert(
        self,
        where: types.PortfolioWhereUniqueInput,
        data: types.PortfolioUpsertInput,
        include: Optional[types.PortfolioInclude] = None,
    ) -> None:
        self._batcher._add(
            method='upsert',
    ...
    def update_many(
        self,
        data: types.PortfolioUpdateManyMutationInput,
        where: types.PortfolioWhereInput,
    ) -> None:
        self._batcher._add(
            method='update_many',
            model=models.Portfolio,
    ...
    def delete_many(
        self,
        where: Optional[types.PortfolioWhereInput] = None,
    ) -> None:
        self._batcher._add(
            method='delete_many',
            model=models.Portfolio,
